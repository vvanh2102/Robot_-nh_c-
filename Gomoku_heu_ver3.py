class GomokuHeuristic:
    ...
    def __init__(self, board, size):
        self.board = board  # Lưu trữ bàn cờ (giờ là list 2D)
    ...
    def row_to_list(self, y, x, dy, dx, yf, xf):
        ...
        while y != yf + dy or x != xf + dx:
            ...
            row.append(self.board[y][x])  # Lấy giá trị từ bàn cờ (giờ là list 2D)
...
class GomokuGame:
    ...
    def print_board(self):
        ...
        for y in range(self.size):
            ...
            for x in range(self.size):
                cell = self.board[y][x]  # Lấy giá trị ô từ bàn cờ
    ...
    def is_winner(self, player):
        ...
        for y in range(self.size):
            for x in range(self.size - 4):
                ...
                # Kiểm tra hàng dọc
                if all(self.board[x + i][y] == player for i in range(5)):
                    return True  # Trả về True nếu có 5 ô liên tiếp
        for y in range(self.size - 4):
            for x in range(self.size - 4):
                ...
                if all(self.board[y + i][x + 4 - i] == player for i in range(5)):
                    return True  # Trả về True nếu có 5 ô liên tiếp
    ...
    def computer_move(self):
        ...
        if best_move:
            self.board[best_move[0]][best_move[1]] = self.computer  # Đánh dấu nước đi của máy tính
